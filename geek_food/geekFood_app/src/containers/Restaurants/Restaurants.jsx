...
const Restaurants = ()=>{
    ...
    return (
        ...
        <div className={styles["filter-container"]}>
            <input type="text" name="" id="" onChange={RestaurantNameFiter} placeholder="Search Restaurants..." />
            <div className={styles['rating-container']}>
                <label htmlFor="rating">Minimum Rating:</label>
                <input type="number" id="rating" max={5} min={0} onChange={RatingFilter}/>
            </div>
            ...
            <div className={styles['container']}>
           {
            RestaurantsList
            .filter((item,index)=>{
                // return item.name.toLowerCase().includes(searchKey.toLowerCase()) && item.rating >= rating;
                if(item.name.toLowerCase().includes(searchKey.toLowerCase().trim()) && Number(item.rating) >= Number(rating)){
                    return true;
                }else{
                    return false;
                }
